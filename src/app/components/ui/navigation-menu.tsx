...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "group flex flex-1 list-none   flex-col gap-2 md:flex-row md:items-center justify-center md:space-x-1",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), "group font-semibold text-text_secondary", className)}
    {...props}
  >
    {children}{""}
    <ChevronDown
